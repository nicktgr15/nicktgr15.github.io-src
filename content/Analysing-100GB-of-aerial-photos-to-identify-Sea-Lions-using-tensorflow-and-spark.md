...
Or to be more accurate: counting the dots. In the following figure two example images from the training data are presented. On the left side the original image is presented while on the right side the sea lions on the image have been annotated using dots of different colours.
